...
public class vc1: UIViewController {
    ...
    open override func viewDidLoad() {
        ...
        pageControl.frame = CGRect(x: 108, y: 645, width: 160, height: 23)
        pageControl.image = UIImage(named: "PAGECONTROL-1")
        ...
        infoView2.frame = CGRect(x: 86, y: 486, width: 271, height: 125)
